...
public class MediaProcessor(ILogger<MediaProcessor> logger, IMediaPaths mediaPaths, ILocationService locationService)
    : IMediaProcessor
{
    ...
    )
    {
        ...
        entry.LocationLabel = await locationService.SearchForLocation(
            entry.Longitude,
            entry.Latitude,
