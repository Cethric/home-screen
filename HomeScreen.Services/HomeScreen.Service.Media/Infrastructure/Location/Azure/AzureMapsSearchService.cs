...
public class AzureMapsSearchService(ILogger<AzureMapsSearchService> logger, MapsSearchClient mapsSearchClient)
    : IAzureMapsSearchService
{
        ...
        return new ReverseSearchAddressResponse
        {
            Addresses = response.Value.Addresses.Select(
                    address => new ReverseSearchAddress
                    {
                        ...
                        MunicipalitySubdivision = address.Address.MunicipalitySubdivision ?? string.Empty,
                        Municipality = address.Address.Municipality ?? string.Empty,
                        CountryTertiarySubdivision = address.Address.CountryTertiarySubdivision ?? string.Empty,
