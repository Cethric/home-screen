...
namespace HomeScreen.Service.Media.Client.Generated
{
    ...
    public enum MediaTransformOptionsFormat
    {
        ...
        [System.Text.Json.Serialization.JsonStringEnumMemberName(@"Jpeg")]
        Jpeg = 0,

        [System.Text.Json.Serialization.JsonStringEnumMemberName(@"JpegXl")]
        JpegXl = 1,

        [System.Text.Json.Serialization.JsonStringEnumMemberName(@"Png")]
        Png = 2,

        [System.Text.Json.Serialization.JsonStringEnumMemberName(@"WebP")]
        WebP = 3,

        [System.Text.Json.Serialization.JsonStringEnumMemberName(@"Avif")]
        Avif = 4,
