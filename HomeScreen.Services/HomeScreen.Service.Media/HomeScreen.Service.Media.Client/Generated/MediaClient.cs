...
namespace HomeScreen.Service.Media.Client.Generated
{
    ...
    #pragma warning restore CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider declaring as nullable.
        ...
        public virtual async System.Threading.Tasks.Task<FileResponse> Download_MediaAsync(System.Guid mediaId, int width, int height, bool blur, MediaTransformOptionsFormat format, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (mediaId == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    // Operation Path: "media/download/item/{mediaId}/{width}/{height}"
                    urlBuilder_.Append("media/download/item/");
        ...
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public virtual async System.Threading.Tasks.Task<SwaggerResponse> Download_Media2Async(int direction, int size, bool blur, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            if (direction == null)
            ...
            try
            {
                using (var request_ = new System.Net.Http.HttpRequestMessage())
                {
                    ...
                    var urlBuilder_ = new System.Text.StringBuilder();
                    if (!string.IsNullOrEmpty(_baseUrl)) urlBuilder_.Append(_baseUrl);
                    // Operation Path: "media/download/line/{direction}/{size}"
                    urlBuilder_.Append("media/download/line/");
