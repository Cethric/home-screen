...
namespace HomeScreen.Service.Media.UnitTests.Infrastructure.Location.Nominatim;
...
public class NominatimLocationServiceUnitTest
{
    ...
    )
    {
        ...
        var logger = new Mock<ILogger<NominatimLocationService>>();
        ...
        var service = new NominatimLocationService(logger.Object, cache.Object, searchService.Object);
        // Act
