...
import { type Direction, type Image, PolaroidModal, type WeatherForecast } from '@homescreen/web-common-components';
...
const activeItems = computed(() =>
  currentId.value && nextId.value && hasImages.value ? [currentId.value, nextId.value] : [],
);
</script>
