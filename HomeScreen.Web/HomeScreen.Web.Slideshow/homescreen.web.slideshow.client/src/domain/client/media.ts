import { injectComponentMediaClient, type MediaItem } from '@homescreen/web-common-components';

export const toggleMedia = async (imageId: string, state: boolean): Promise<MediaItem | undefined> => {
